...
CREATE TABLE Observation (
    ...
    obj_obj_id INT;
    pos_pos_id INT;
    FOREIGN KEY (ntob_ntob_id) REFERENCES NaturalObject(id),
    FOREIGN KEY (sctr_sctr_idd) REFERENCES Sector(id)
    FOREIGN KEY (iobj_obj_id) REFERENCES Objects(id),
    FOREIGN KEY (pos_pos_id) REFERENCES Position(id)
